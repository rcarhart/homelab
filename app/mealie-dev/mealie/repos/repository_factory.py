...
from mealie.db.models.shared import (
    SharedRecipeCollection,
    SharedRecipeCollectionMember,
    SharedRecipeComment,
    SharedRecipeLink,
)
...
class AllRepositories:
    ...
    @cached_property
    def shared_recipe_collections(self) -> GroupRepositoryGeneric[SharedRecipeCollectionOut, SharedRecipeCollection]:
        return GroupRepositoryGeneric(
            self.session,
            PK_ID,
            SharedRecipeCollection,
    ...
    @cached_property
    def shared_recipe_collection_members(
        self,
    ) -> GroupRepositoryGeneric[SharedRecipeCollectionMemberOut, SharedRecipeCollectionMember]:
        return GroupRepositoryGeneric(
            self.session,
            PK_ID,
            SharedRecipeCollectionMember,
    ...
    @cached_property
    def shared_recipe_links(self) -> GroupRepositoryGeneric[SharedRecipeLinkOut, SharedRecipeLink]:
        return GroupRepositoryGeneric(
            self.session,
            PK_ID,
            SharedRecipeLink,
    ...
    @cached_property
    def shared_recipe_comments(self) -> GroupRepositoryGeneric[SharedRecipeCommentOut, SharedRecipeComment]:
        return GroupRepositoryGeneric(
            self.session,
            PK_ID,
            SharedRecipeComment,
